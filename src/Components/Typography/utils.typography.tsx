...
export const tagsByType = (
  ...
  const classDefault = `leading-[142%] inline tracking-[0.18px] ${noWrap ? 'whitespace-nowrap' : ''
      ...
      <h6
        className={
          ...
          `text-[1.125rem] ${bold
            ? 'font-semibold font-LoraSemiBold'
            : 'font-medium font-LoraMedium'
          } leading-[124%] tracking-[0.18px] ${otherClasses ? otherClasses : ''
          }`
        }
      >
        {children}
    ...
    b1: ({ children }) => (
      <p
        className={
          ...
          } leading-[132%] tracking-[0.18px] ${otherClasses ? otherClasses : ''
          }`
        }
      >
        {children}
      ...
      <p
        className={
          ...
          `text-base ${bold
            ? 'font-medium font-DMSansMedium'
            : 'font-normal font-DMSansRegular'
          } leading-[140%] tracking-[0.16px] ${otherClasses ? otherClasses : ''
          }`
        }
      >
        {children}
    ...
    b3: ({ children }) => (
      <p
        className={
          ...
          } leading-[142%] tracking-[0.14px] ${otherClasses ? otherClasses : ''
          }`
        }
      >
        {children}
      ...
      <p
        className={
          ...
          `text-xs ${bold
            ? 'font-medium font-DMSansMedium'
            : 'font-normal font-DMSansRegular'
          } leading-[142%] tracking-[0.12px] ${otherClasses ? otherClasses : ''
          }`
        }
      >
        {children}
